...
class BlueprintGenerationTool(BaseTool):
    ...
    def execute(self, input_data: Dict[str, Any]) -> ToolResult:
        ...
        print(f"Starting blueprint generation for topic: {topic_name}")
        source_data_ids = input_data.get("source_data_ids")
        print(f"Source_data_id: {source_data_ids}")
        if source_data_ids is not None and len(source_data_ids) == 1:
            ...
            return ToolResult(
                        ...
                        data={
                            ...
                            "source_data_version_hash": "test_BPhash",
                            "blueprint_summary": "test_BPsummary"
                        },
                        metadata={
                            "topic_name": topic_name,
                            "source_data_ids": source_data_ids,
                            "cognitive_maps_count": 0
                        }
                    )
        elif source_data_ids is not None and len(source_data_ids) == 3:
            return ToolResult(
                        success=True,
                        data={
                            "blueprint_id": "batch exist",
                            "reused_existing": True,
                            "contributing_source_data_count": 1,
                            "source_data_version_hash": "test_BPhash",
                            "blueprint_summary": "test_BPsummary"
