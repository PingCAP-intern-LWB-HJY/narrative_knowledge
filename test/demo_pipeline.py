...
def demo_batch_documents_existing_topic():
    ...
    request_data = {
        ...
        "metadata": {"topic_name": "tidb_docs", "is_new_topic": False},
...
def demo_new_topic_batch():
    ...
    request_data = {
        "target_type": "knowledge_graph",
        "metadata": {"topic_name": "new_tidb_topic", "is_new_topic": True},
        "process_strategy": {"pipeline": ["etl", "blueprint_gen", "graph_build"]},
    }
